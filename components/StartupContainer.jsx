...
function StartupContainer(props) {
  return (
    <div
      id={props.id}
      className={`w-10/12 h-72 max-w-[1000px] bg-white flex flex-col justify-center items-center border-dotted border-black border-2 rounded-sm absolute top-1/5 ${props.className}`}
    >
